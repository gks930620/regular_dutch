...
- [*] 권한 최소화 및 개인정보 점검
- [ ]  앱 아이콘 이미지 구성하기 
- [ ] 구글 플레이 콘솔 설정 및 내부 테스트 트랙 배포  (비공개테스트 어려워서 킾)
- [ ]  원스토어 배포해보기 
...
복잡한 정산앱이 아니라 단순히 누가 낼 차례인가, 누가 할 차례인가 등을 알려주는 앱입니다.
그룹화면에서 원하는 그룹을 만들고  그 그룹에서 누가 할 차례인지만 기록하세요.
다음에 누가 할 차례인지 앱이 알려줍니다. ㄴ 단순히 누가 낼 차례인가, 누가 할 차례인가 등을 알려주는 앱입니다.
그룹화면에서 원하는 그룹을 만들고  그 그룹에서 누가 할 차례인지만 기록하세요.
다음에 누가 할 차례인지 앱이 알려줍니다. 